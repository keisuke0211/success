...
void InitResult1(void)
{
	...
	//｜　テクスチャの読み込み　｜
	//◇――――――――――――◇
	D3DXCreateTextureFromFile(pDevice, ".\\data\\TEXTURE\\bg002.jpg", &g_pTextureResult1[0]);

	D3DXCreateTextureFromFile(pDevice, ".\\data\\TEXTURE\\GAMEOVER.png", &g_pTextureResult1[1]);
