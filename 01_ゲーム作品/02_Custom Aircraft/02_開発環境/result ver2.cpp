...
void InitResult2(void)
{
	...
	//｜　テクスチュの読み込み　｜
	//◇――――――――――――◇
	D3DXCreateTextureFromFile(pDevice, ".\\data\\TEXTURE\\bg001.jpg", &g_pTextureResult2[0]);
	D3DXCreateTextureFromFile(pDevice, ".\\data\\TEXTURE\\GAMECLEAR.png", &g_pTextureResult2[1]);
