...
void InitScore(void)
{
	...
	D3DXCreateTextureFromFile(pDevice, ".\\data\\TEXTURE\\number000.png", &g_pTextureScore);
		...
		g_posScore = D3DXVECTOR3(SCREEN_WIDTH / 2, SCREEN_HEIGHT - 200, 0);	//位置を初期化
		g_nScore = 0;														//値を初期化
...
void UpdateScore(void)
{
	...
	for (nCntScore = 0; nCntScore < NUM_PLACE; nCntScore++,pVtx += 4)
	{
		...
		pVtx[0].pos = D3DXVECTOR3(1070.0f + (nCntScore * 25.0f), 210.0f, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(1090.0f + (nCntScore * 25.0f), 210.0f, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(1070.0f + (nCntScore * 25.0f), 250.0f, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(1090.0f + (nCntScore * 25.0f), 250.0f, 0.0f);
	}
	//頂点バッファのアンロック
	g_pVtxbuffScore->Unlock();
}
