...
void SetResult(int nScore)
{
	...
	aTexU[0] = g_nTime11 % 1000 / 100;
	aTexU[1] = g_nTime11 % 100 / 10;
	aTexU[2] = g_nTime11 % 10 / 1;
	...
	for (nCntScore = 0; nCntScore < NUM_PLACE; nCntScore++, pVtx += 4)
	{
		...
		pVtx[0].pos = D3DXVECTOR3(500.0f + (nCntScore * 85.0f), 480.0f, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(540.0f + (nCntScore * 85.0f), 480.0f, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(500.0f + (nCntScore * 85.0f), 570.0f, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(540.0f + (nCntScore * 85.0f), 570.0f, 0.0f);
