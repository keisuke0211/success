...
void Update(void)
{
	...
	case MODE_RESULY2:		//リザルト画面１　ゲームオーバー
		UpdateResult2();
		break;
...
void Draw(void)
{
	...
	{//描画開始が成功した場合
	 ...
	 //＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
		...
		RECT rect1 = { 300,0,SCREEN_WIDTH,SCREEN_HEIGHT };
		RECT rect2 = { 700,0,SCREEN_WIDTH,SCREEN_HEIGHT };
...
void DrawFPS(void)
{
	...
	//文字列に代入
	sprintf(&aStr[0], "FPS:%d\n角度:%f\nプレイヤーの座標X:%0.1f\n　　　　　　座標Y:%0.1f\n摩擦　　　　　　:%0.1f\n", g_nCountFPS, Getplayer()->fTwo_Angle,Getplayer()->pos.x,Getplayer()->pos.y,Getplayer()->rot_spd);
