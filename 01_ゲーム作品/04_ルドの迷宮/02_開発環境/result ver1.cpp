...
void InitResult1(void)
{
	...
	g_Result1[0].bUse = true;
	g_Result1[1].bUse = false;
	//◇――――――――――――◇
	//｜　　 アニメーション 　　｜
	//◇――――――――――――◇
...
void UpdateResult1(void)
{
	...
	{//点滅切り替え時間になった
		g_Result1[1].bUse = g_Result1[1].bUse ? false : true;
		g_nCnTFlash1 = 0;
	}
...
void DrawResult1(void)
{
	...
	for (int nCntResult = 0; nCntResult < NUM_BG; nCntResult++)
	{
		if (g_Result1[nCntResult].bUse == true)
		{
			//◇――――――――――――◇
			//｜データストリームの設定　｜
			//◇――――――――――――◇
			...
			//｜　　テクスチュの設定　　｜
			//◇――――――――――――◇
				pDevice->SetTexture(0, g_pTextureResult1[nCntResult]);
				//◇――――――――――――◇
				//｜　　ポリゴンの描画　　　｜
				//◇――――――――――――◇
